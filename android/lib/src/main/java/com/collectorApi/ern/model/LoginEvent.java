...
package com.collectorApi.ern.model;
...
public class LoginEvent implements Parcelable, Bridgeable {
    ...
    private LoginEvent(Builder builder) {
        this.id = builder.id;
        this.name = builder.name;
        this.desc = builder.desc;
    }

    private LoginEvent(Parcel in) {
        this(in.readBundle());
    }

    public LoginEvent(@NonNull Bundle bundle) {
    ...
    public static final Creator<LoginEvent> CREATOR = new Creator<LoginEvent>() {
        @Override
        public LoginEvent createFromParcel(Parcel in) {
            return new LoginEvent(in);
        }
